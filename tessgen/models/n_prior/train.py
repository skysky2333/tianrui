...
def main() -> None:
    ...
    export_n_prior_pt(
        lit=best_lit,
        out_path=str(Path(args.out_dir) / "n_prior.pt"),
    ...
    make_report_and_figures(run_dir=args.out_dir, history_path=history_path, logn_true=logn_true, mu=mu, log_sigma=log_sigma)
