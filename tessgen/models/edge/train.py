...
def main() -> None:
    ...
    test_eval = eval_edge_model(lit=best_lit.to(torch.device("cuda" if dev.accelerator == "gpu" else dev.accelerator)), dl=dl_test, thr=float(args.thr), max_pairs=int(args.max_pairs_report))
